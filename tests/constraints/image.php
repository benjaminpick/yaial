 ...
 * @link https://github.com/naderman/ezc-unit-test/blob/master/src/constraint/image.php
 */
 ...
 * (Uses commandline version of image magick.)
 *
 * @package UnitTest
 * @version //autogentag//
 */
class ezcTestConstraintSimilarImage extends PHPUnit_Framework_Constraint
{
    ...
    public function evaluate( $other )
    {
        if ( !is_string( $other ) ||
             ...
             !is_readable( $other ) )
        {
            throw new Exception( "File not found: $other" );
       	}
        ...
        // Different versions of ImageMagick seem to output "dB" or not
    ...
    public function fail( $other, $description, $not = false )
    {
        $failureDescription = sprintf(
          'Failed asserting that image "%s" is similar to image "%s" (diff: %d).',
